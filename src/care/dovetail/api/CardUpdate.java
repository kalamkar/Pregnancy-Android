...
public class CardUpdate extends ApiResponseTask {
	private static final String TAG = "CardUpdate";
	...
	protected HttpRequestBase makeRequest(Pair<String, String>... params)
		...
		HttpEntityEnclosingRequestBase request = new HttpPut(Config.CARD_URL);
